                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class="d-flex flex-column align-items-center text-center">
                        <img src="data:image/jpg;base64,${animal.base64Image}" alt="Admin"  width="200">
                        <div class="mt-3">
                          <p class="text-muted font-size-sm">${animal.location}</p>
                          <p class="text-danger">Posted By : ${user.fName} ${user.lName} </p>


                          <c:if test="${!animal.served && param.type != 'request_' && param.type != 'submit' }">
                          <a href="search_page_entry?type=request_&id=${animal.id}&to=${user.email}&username=${user.username}&category=${animal.category}&description=${animal.description}" style="text-decoration: none;color:black;"><button class="btn btn-primary">Request For OTP</button></a>
                          </c:if>
                          ...
                          <c:if test="${animal.served}">
                            <hr>
                          <p style="font-weight: bold;">Rescued <img src="done.gif" width="12%" height="12%"></p>
                          </c:if>
                        

                          <c:if test="${!animal.served && param.type == 'request_' && requestScope.status}">


                          <form method="post" action="search_page_entry?type=submit&id=${animal.id}&to=${user.username}">
...
<div id="snackbar">${requestScope.message}</div>
